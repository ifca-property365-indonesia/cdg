                            ...
                            <tr>
                                <td style="padding: 30px 30px">
                                    <h5 style="text-align:left;margin-bottom: 24px; color: #000000; font-size: 20px; font-weight: 400; line-height: 28px;">Dear Mr./Mrs. {{ $dataArray['user_name'] }}, </h5>
                                        <p style="text-align:left;margin-bottom: 15px; color: #000000; font-size: 16px;">Please approve Purchase Requisition No. {{ $dataArray['req_hd_no'] }} for {{ $dataArray['req_hd_descs'] }}.</p><br>
